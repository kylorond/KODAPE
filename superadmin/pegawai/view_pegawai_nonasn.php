...
<div class="card-header mb-4" style="background-color: #F4CE14; color: black;">
    <h3 class="card-title" style="font-weight: bold;">Biodata Tenaga Kontrak</h3>
</div>
<div class="row">
<div class="col-md-6">
    <div class="card">
    ...
    <div class="mt-3">
        <a href="?page=data-pegawai-nonasn" class="btn" style="background-color: #CD1818; color: white; font-weight: bold;">Kembali</a>
        <a href="./report/cetak-data-keluarga-nonasn.php?nip=<?php echo $data_cek['nip']; ?>" target="_blank" title="Cetak Data Keluarga Tenaga Kontrak" class="btn" style="background-color: #16FF00; color: black; font-weight: bold;">Cetak Data</a>
        <a href="?page=edit-pegawai-nonasn&kode=<?php echo $data_cek['nip']; ?>" class="btn" style="background-color: #068FFF; color: white; font-weight: bold;">Edit Data</a>
        <a href="?page=input-formulir-cuti-nonasn&kode=<?php echo $data_cek['nip']; ?>" title="Cuti" class="btn" style="background-color: #FB2576; color: black; font-weight: bold;">Cuti</a>
    </div>
</div>
