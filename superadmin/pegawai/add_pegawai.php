<div class="card-header" style="background-color: #0E21A0; color: white;">
    ...
    <i class="fa fa-edit"></i> Tambah Data Pegawai & Tekon</h3>
</div>
<div class="row">
<div class="col-md-6">
    <div class="card">
		...
		<form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                <label class="col-sm-4 col-form-label">NIP/NRPK*</label>
                <div class="col-sm-8">
                    <input type="text" style="background-color: transparent; color: black; border-radius: 10px;" class="form-control" id="nip" name="nip" placeholder="NIP/NRPK" pattern="[0-9 .]+" title="Hanya angka, titik, dan spasi yang diperbolehkan" />
                </div>
            </div>
            <script>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="date" style="background-color: transparent; color: black; border-radius: 10px;" class="form-control" id="tanggal_masuk" name="tanggal_masuk" oninput="validateTanggal1()">
                </div>
            </div>
            <script>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" style="background-color: transparent; color: black; border-radius: 10px;" style="background-color: transparent; color: white; border-radius: 10px;" class="form-control" id="pangkat" name="pangkat" placeholder="Pangkat">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-4 col-form-label">Golongan</label>
                <div class="col-sm-8">
                <select name="golongan" style="background-color: transparent; color: black; border-radius: 10px;" id="golongan" class="form-control">
                        <option>-- Pilih --</option>
                        <option>I/a</option>
                        <option>I/b</option>
                        <option>I/c</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="date" style="background-color: transparent; color: black; border-radius: 10px;" class="form-control" id="tmt_golongan" name="tmt_golongan" oninput="validateTanggal3()">
                </div>
            </div>
            <script>
    ...
    <table class="table" border="1" style="border-collapse: collapse; width: 100%; border: 1px solid black;">
		...
		<div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" style="background-color: transparent; color: black; border-radius: 10px;" class="form-control" id="karpeg" name="karpeg" placeholder="Nomor Kartu Pegawai (KARPEG)">
                </div>
            </div>
	...
	<input type="submit" name="Simpan" value="SIMPAN" class="btn" style="background-color: #F4CE14; font-weight: bold;">
            <a href="?page=data-pegawai" title="Kembali" class="btn" style="background-color: #CD1818; color: white; font-weight: bold;">BATAL</a>
        </div>
    </form>
</div>
</div>
...
<?php
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_pegawaisatpolpp (nip, tanggal_honor, tanggal_masuk, nama, keterangan, 
        tempat_lahir, tanggal_lahir, jenis_kelamin, agama, gol_darah, no_bpjs, status_kepegawaian,
        pangkat, golongan, tmt_golongan, pendidikan, jurusan, konsentrasi, alumni, tahun_lulus, 
        jabatan, penempatan, unit, instansi, masagolongan, gaji, no_telp, npwp, nik,
        karpeg, alamat, ukuran_baju, ukuran_celana, ukuran_topi, ukuran_sepatu, no_rek) VALUES (
            '".$_POST['nip']."',
            '".$_POST['tanggal_honor']."',
            '".$_POST['tanggal_masuk']."',
            '".$_POST['nama']."',
    ...
    if ($query_simpan) {
      echo "<script>
      Swal.fire({title: 'Tambah Data Pegawai/Tenaga Kontrak Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
      ...
      echo "<script>
      Swal.fire({title: 'Tambah Data Pegawai/Tenaga Kontrak Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
      }).then((result) => {if (result.value){
