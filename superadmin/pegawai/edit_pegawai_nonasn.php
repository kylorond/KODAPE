...
<h3 class="card-title" style="font-weight :bold;">
            <i class="fa fa-edit"></i> Ubah Data Tenaga Kontrak</h3>
</div>
<div class="row">
<div class="col-md-6">
    <div class="card">
...
if (isset ($_POST['Ubah'])){
    ...
    if ($query_ubah) {
        echo "<script>
        Swal.fire({title: 'Ubah Data Tenaga Kontrak Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
        }).then((result) => {
            if (result.value) {
        ...
        echo "<script>
        Swal.fire({title: 'Ubah Data Tenaga Kontrak Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
        }).then((result) => {
            if (result.value) {
                window.location = 'index.php?page=data-pegawai-nonasn';
            }
