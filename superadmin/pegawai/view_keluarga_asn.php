				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td>:
							<?php
if (!empty($data_cek['kelahiran'])) {
    $tanggal_kelahiran = $data_cek['kelahiran'];
    $tanggal_kelahiran_parts = explode('/', $tanggal_kelahiran);

    if (count($tanggal_kelahiran_parts) === 3) {
        $day = $tanggal_kelahiran_parts[1];
        $month = $tanggal_kelahiran_parts[0];
        $year = $tanggal_kelahiran_parts[2];
        ...
        $bulan = $bulan_indonesia[(int)$month - 1];
