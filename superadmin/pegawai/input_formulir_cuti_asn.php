...
<div class="card" style="background-color: #EEEDED; color: blakc;">
	<div class="card-header" style="background-color: #FB2576; color: white;">
		<h3 class="card-title" style="font-weight: bold;">
			<i class="fa fa-edit"></i> Input Cuti Pegawai</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="card-footer">
			...
			<a href="?page=data-cuti-asn" title="Kembali" class="btn" style="background-color: #CD1818; color: white; font-weight: bold;">BATAL</a>
		</div>
	</form>
</div>
<?php
    ...
    if ($query_simpan) {
		...
		Swal.fire({
		  ...
		  if (result.value) {
			...
			window.open('report/cetak-formulir-cuti-asn.php?nip=" . $data_cek['nip'] . "');
		  }
		})
  	</script>";
      }else{
