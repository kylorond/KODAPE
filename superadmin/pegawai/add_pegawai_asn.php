<div class="card-header" style="background-color: #0E21A0; color: white;">
    ...
    <i class="fa fa-edit"></i> Tambah Data Pegawai</h3>
</div>
<div class="row">
<div class="col-md-6">
    <div class="card">
		...
		<form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" style="background-color: transparent; color: black; border-radius: 10px;" class="form-control" id="nip" name="nip" placeholder="NIP" pattern="[0-9 .]+" title="Hanya angka, titik, dan spasi yang diperbolehkan" />
                </div>
            </div>
            <script>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="date" style="background-color: transparent; color: black; border-radius: 10px;" class="form-control" id="tanggal_masuk" name="tanggal_masuk" oninput="validateTanggal1()" required>
                </div>
            </div>
            <script>
...
<?php
    ...
    if ($query_simpan) {
      echo "<script>
      Swal.fire({title: 'Tambah Data Pegawai Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
      ...
      echo "<script>
      Swal.fire({title: 'Tambah Data Pegawai Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
      }).then((result) => {if (result.value){
          window.location = 'index.php?page=add-pegawai-asn';
          }
      })</script>";
    }
    }
