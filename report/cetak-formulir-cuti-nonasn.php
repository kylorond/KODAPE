...
<head>
    ...
    <title>CETAK FORMULIR CUTI TENAGA KONTRAK</title>
    <style type="text/css">
    ...
    <table class="isitabel" border="1px" cellpadding="3" style="width: 100%;">
                ...
                <table class="isitabel" border="1px" cellpadding="3" style="width: 100%; border-top: none; ">
                    <thead>
                        ...
                        <p style="font-size: medium; text-align: center; margin: 0; padding: 0;">NRPK. <?php echo $data_cuti['nip']; ?></p></td>
                        </tr>
                    </thead>
                </table>
                <br>
