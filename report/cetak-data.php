...
<head>
    ...
    <title>CETAK DATA-DATA PEGAWAI DAN TENAGA KONTRAK</title>
    <style type="text/css">
        body {
            font-family: arial;
...
<body>
    <div class="rangkasurat">
        ...
        <td>
            <h2 class="tengah">
            <h2 class="tengah">DATA PEGAWAI DAN TENAGA KONTRAK SATUAN POLISI PAMONG PRAJA</h2>
            ...
            <div class="table-responsive">
                ...
                <table class="isitabel" border="1px" cellpadding="3">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($koneksi, "SELECT * FROM tb_pegawaisatpolpp");
                        $no = 1;
