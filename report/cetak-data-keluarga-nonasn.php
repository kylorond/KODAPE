...
<head>
    ...
    <title>CETAK BIODATA TENAGA KONTRAK</title>
    <style type="text/css">
...
<body>
    <div class="rangkasurat">
		...
		<br>
		<td>
		<h2 class="tengah">BIODATA TENAGA KONTRAK SATUAN POLISI PAMONG PRAJA</h2>
		...
		<tbody>
			...
			<tr class="justify">
				<td style="width: 38%;">NRPK</td>
				<td style="width: 2%;">:</td>
				<td><?php echo $data['nip']; ?></s></td>
			</tr>
			<!-- <tr class="justify">
				<td style="width: 38%;">Tanggal Masuk</td>
				<td style="width: 2%;">:</td>
				<td><?php echo $data['tanggal_masuk']; ?></s></td>
			</tr> -->
			<tr class="justify">
			...
			<tr>
				...
				<td>Diperkirakan akan naik pangkat pada 
					...
					echo $naik_pangkat->format('d-m-Y');
					?>
				</td>
			</tr> -->
            <tr class="justify">
