...
<head>
    ...
    <title>CETAK DAFTAR PEGAWAI AKTIF</title>
    <style type="text/css">
        body {
            font-family: arial;
...
<body>
    <div class="rangkasurat">
        ...
        <td>
            <h2 class="tengah">
            <h2 class="tengah">DATA PEGAWAI AKTIF SATUAN POLISI PAMONG PRAJA</h2>
            ...
            <div class="table-responsive">
                ...
                <table class="isitabel" border="1px" cellpadding="3">
                    ...
                    <tbody>
                        ...
                        $query = mysqli_query($koneksi, "SELECT * FROM tb_pegawaisatpolpp where keterangan='Aktif'");
                        $no = 1;
